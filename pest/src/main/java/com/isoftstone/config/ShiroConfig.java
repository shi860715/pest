...
import com.isoftstone.shiro.FormAuthenticationCaptchaFilter;
import com.isoftstone.shiro.MyShiroRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager){
        ...
        FormAuthenticationCaptchaFilter myCaptchaFilter = new FormAuthenticationCaptchaFilter();
        filters.put("authc", myCaptchaFilter);
        shiroFilterFactoryBean.setFilters(filters);
        //拦截器.
        Map<String,String> filterChainDefinitionMap = new LinkedHashMap<String,String>();

        //配置退出 过滤器,其中的具体的退出代码Shiro已经替我们实现了
        filterChainDefinitionMap.put("/yzm", "anon");
        ...
        filterChainDefinitionMap.put("/imgView/**","anon");
