...
@Table(name = "t_standard_survey")
public class StandardSurvey extends BasicPage implements Serializable {
	...
	public String toString() {
		return "StandardSurvey [id=" + id + ", fieldId=" + fieldId + ", images=" + images + ", pest=" + pest
				+ ", hostPlant=" + hostPlant + ", harmPart=" + harmPart + ", victimsRate=" + victimsRate
				+ ", harmDegree=" + harmDegree + ", isDisaster=" + isDisaster + ", remark=" + remark + ", insectStatus="
				+ insectStatus + "]";
	}
