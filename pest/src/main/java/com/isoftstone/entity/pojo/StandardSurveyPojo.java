...
public class StandardSurveyPojo extends StandardSurvey {

	/**
	 * 序列号
	 */
	private static final long serialVersionUID = -5671086291195912030L;
	...
	public String toString() {
		return "StandardSurveyPojo [fieldName=" + fieldName + ", districtId=" + districtId + ", districtName=" + districtName
				+ ", districtCode=" + districtCode + ", townshipName=" + townshipName + ", townshipCode=" + townshipCode
				+ ", placeName=" + placeName + ", type=" + type + ", number=" + number + ", acreage=" + acreage
				+ ", currentClass=" + currentClass + ", deputyAcreage=" + deputyAcreage + ", lon=" + lon + ", lat="
