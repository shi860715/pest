    ...
    $(document).on('click', '.fs-option', function() {
        ...
        if($(this).attr('data-value')=='all'){
        	if($(this).attr('class').indexOf('selected')!=-1){
	        	$(this).parent().parent().find('.fs-option').each(function(){
	        		$(this).addClass('selected');
        ...
        if(selected!='all' && $(this).attr('class').indexOf('selected')==-1){
        	$(this).parent().parent().find('.fs-option').each(function(){
        		if('all' == $(this).attr('data-value')){
        			$(this).removeClass('selected')
        		}
        	});
        }else{
        	var total = $(this).parent().parent().find('.fs-option').length;
        	var columns = $(this).parent().parent().find('.selected').length;
        	if((total-1)==columns){
        		$(this).parent().parent().find('.fs-option').addClass('selected');
        	}
        }
